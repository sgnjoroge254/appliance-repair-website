...
const steps = [
  {
    step: "01",
    title: "Book a repair",
    body: "Tell us the appliance, brand, and what's going wrong. We'll ask a few questions to understand the fault before scheduling.",
  },
  {
    step: "02",
    title: "Diagnosis",
    body: "A technician inspects the appliance — in-home for large appliances, or at our workshop for smaller items — and identifies the fault.",
  },
  {
    step: "03",
  ...
  },
  {
    step: "04",
    title: "Repair",
    body: "We carry out the repair using [sourced / OEM / compatible] parts and test the appliance under normal operating conditions.",
  },
  {
    step: "05",
