      ...
      <section className="border-b border-steelline bg-steel px-6 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-xl font-body text-sm text-ink/70">
            [1–2 sentences on your general approach — diagnosis-first, transparent pricing, parts sourcing, whatever's true for your business.] Exact turnaround depends on the fault, parts availability, and what's found during diagnosis.
          </p>
        </div>
      </section>
